...
public final class HttpRequestComposer {
    ...
    public static final class Composer {
        ...
        public Composer withContentType(ContentType ct) {
            headers.put("Content-Type", ct.headerContent);
            return this;
        }

        public Composer auth(AuthType at, String token) {
            headers.put("Authorization", String.format("%s %s", at.headerContent, token));
            return this;
        }

        public Composer via(HTTPMethod m) {
            method = m;
            return this;
        }

        public Composer payload(String p) {
            payload = p;
            return this;
        }

        public Composer userAgent(String ua) {
            if (ua != null && !ua.trim().isEmpty())
                headers.put("User-Agent", ua);
            return this;
        }

        public Composer setHeader(String header, String value) {
